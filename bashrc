...
#funcs
blog(){
xfce4-terminal -e /home/kevin/bin/runpelican.sh &
#xfce4-terminal --working-directory=/home/kevin/blog/content/
sleep 3s
google-chrome 127.0.0.1:8000 &
cd /home/kevin/blog/content/
}
...
workon(){
    if [ $1 ]
    then
        source /home/kevin/virtualenv/$1/bin/activate
    else
        echo "Nothing."
    fi
}
...
export PATH="/home/kevin/anaconda/bin:$PATH"
